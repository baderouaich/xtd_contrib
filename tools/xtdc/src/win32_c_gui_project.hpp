  ...
  private:
    ...
    void create_source(const xtd::string& name, const xtd::string& path) const {
      auto lines = xtd::array<xtd::string> {
        ...
        "  window1.hwnd = CreateWindowEx(0, WC_DIALOG, L\"Window1\", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, 800, 450, NULL, NULL, hInstance, NULL);",
        "  window1.defWndProc = (WNDPROC)SetWindowLongPtr(window1.hwnd, GWLP_WNDPROC, (LONG_PTR)Window1WndProc);",
        "  ",
        "  MSG message;",

...
namespace xtd {
  ...
  namespace native {
    ...
    protected:
      ...
      /// @warning Internal use only
      static auto at_quick_exit(void (*on_quick_exit)(void)) -> std::int32_t;
      ...
      /// @warning Internal use only
      static auto get_distribution_version(std::int32_t& major, std::int32_t& minor, std::int32_t& build, std::int32_t& revision) -> void;
      ...
      /// @warning Internal use only
      static auto get_os_version(std::int32_t& major, std::int32_t& minor, std::int32_t& build, std::int32_t& revision) -> void;
      ...
      /// @warning Internal use only
      [[noreturn]] static auto quick_exit(std::int32_t exit_code) noexcept -> void;
      ...
      /// @warning Internal use only
      static auto set_environment_variable(const std::string& name, const std::string& value, std::int32_t target) -> void;
      /// @brief Deletes an environment variable stored in the current process.
      /// @param variable The name of an environment variable.
      /// @warning Internal use only
      static auto unset_environment_variable(const std::string& name, std::int32_t target) -> void;

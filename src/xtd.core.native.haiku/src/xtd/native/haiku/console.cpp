...
int32_t console::input_code_page() {
  // There is no way to define the console input code page under haiku.
...
bool console::number_lock() {
  /// @todo number lock status on haiku
  return ::number_lock;
}

int32_t console::output_code_page() {
  // There is no way to define the console output code page under haiku.
...
std::string console::title() {
  /// @todo get console get title on haiku
...
bool console::window_height(int32_t height) {
  /// @todo set console window height on haiku
  ::window_height = height;
  return true;
}

int32_t console::window_left() {
  /// @todo get console window left on haiku
  return ::window_left;
}

bool console::window_left(int32_t left) {
  /// @todo set console window left on haiku
  ::window_left = left;
  return true;
}

int32_t console::window_top() {
  /// @todo get console window top on haiku
  return ::window_top;
}

bool console::window_top(int32_t top) {
  /// @todo set console window top on haiku
  ::window_top = top;
  return true;
}
...
bool console::window_width(int32_t width) {
  /// @todo set console window width on haiku
  ::window_width = width;
  return true;
}

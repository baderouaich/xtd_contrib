...
namespace xtd {
  ...
  namespace forms {
    ...
    class forms_export_ folder_browser_dialog final : public xtd::forms::common_dialog {
      struct data;
    ...
    public:
      ...
      [[nodiscard]] auto auto_upgrade_enable() const noexcept -> bool;
      ...
      [[nodiscard]] auto root_folder() const noexcept -> xtd::environment::special_folder;
      ...
      [[nodiscard]] auto selected_path() const noexcept -> const xtd::string&;
      ...
      [[nodiscard]] bool show_new_folder_button() const noexcept;

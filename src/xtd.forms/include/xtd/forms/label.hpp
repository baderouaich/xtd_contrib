...
namespace xtd {
  ...
  namespace forms {
    ...
    class forms_export_ label : public xtd::forms::control {
      struct data;
    ...
    public:
      ...
      [[nodiscard]] virtual auto shadow() const noexcept -> bool;
      ...
      [[nodiscard]] virtual auto shadows() const noexcept -> const xtd::forms::shadows&;
      ...
      [[nodiscard]] static auto create() -> label;
      ...
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location) -> label;
      ...
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size) -> label;
      ...
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> label;
      ...
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::string& text) -> label;
      /// @brief A factory to create an xtd::forms::label with specified text, and location.
      /// @param text A string that represent text of the xtd::forms::label.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::string& text, const xtd::drawing::point& location) -> label;
      /// @brief A factory to create an xtd::forms::label with specified text, location, and size.
      /// @param text A string that represent text of the xtd::forms::label.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::label.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size) -> label;
      ...
      /// @param name The name of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> label;
      ...
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent) -> label;
      /// @brief A factory to create an xtd::forms::label with specified parent, location.
      /// @param parent The parent that contains the new created xtd::forms::label.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location) -> label;
      /// @brief A factory to create an xtd::forms::label with specified parent, location, and size.
      /// @param parent The parent that contains the new created xtd::forms::label.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::label.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size) -> label;
      ...
      /// @param name The name of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> label;
      /// @brief A factory to create an xtd::forms::label with specified parent, and text.
      /// @param parent The parent that contains the new created xtd::forms::label.
      /// @param text A string that represent text of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text) -> label;
      /// @brief A factory to create an xtd::forms::label with specified parent, text, and location.
      /// @param parent The parent that contains the new created xtd::forms::label.
      /// @param text A string that represent text of the xtd::forms::label.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, const xtd::drawing::point& location) -> label;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size) -> label;
      ...
      /// @param name The name of the xtd::forms::label.
      /// @return New xtd::forms::label created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> label;
      /// @}

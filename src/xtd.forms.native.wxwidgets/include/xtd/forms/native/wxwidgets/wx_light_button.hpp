...
namespace xtd {
  namespace forms {
    namespace native {
      class button;
      class control;
      class wx_light_button : public control_handler {
        friend xtd::forms::native::button;
        friend xtd::forms::native::control;
      private:
        explicit wx_light_button(const xtd::forms::native::create_params& create_params) {
        ...
        static long style_to_wx_user_window_style(xtd::usize style, xtd::usize ex_style) {
          long wx_style = common_control_style_to_wx_style(style, ex_style);

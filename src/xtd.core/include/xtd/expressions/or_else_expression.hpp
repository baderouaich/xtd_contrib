/// @file
/// @brief Contains xtd::expressions::or_else_expression operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::or_else_expression is the or expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    ...
    struct or_else_expression : binary_expression {
      ...
      /// @{
      /// @brief Initialize a new xtd::expressions::or_else_expression object with specified left and right operands.
      /// @param left The left operand.
      /// @param right The right operand.
      constexpr or_else_expression(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
    ...
    constexpr auto operator ||(left_t left, right_t right) {
      ...
      return or_else_expression<std::decay_t<decltype(left_expression)>, std::decay_t<decltype(right_expression)>> {std::move(left_expression), std::move(right_expression)};
    }
    /// @}
  }
}

/// @file
/// @brief Contains xtd::expressions::add_expression operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::add_expression is the add expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    ...
    struct add_expression : binary_expression {
      ...
      constexpr add_expression(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}

/// @file
/// @brief Contains xtd::expressions::greater_than_or_equal_expression operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::greater_than_or_equal_expression is the greater or equal expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    ...
    struct greater_than_or_equal_expression : binary_expression {
      ...
      /// @{
      /// @brief Initialize a new xtd::expressions::greater_than_or_equal_expression object.
      constexpr greater_than_or_equal_expression() = default;
      
      /// @brief Initialize a new xtd::expressions::greater_than_or_equal_expression object with specified left and right operands.
      /// @param left The left operand.
      /// @param right The right operand.
      constexpr greater_than_or_equal_expression(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const greater_than_or_equal_expression& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " >= " << expression_stream {e.right, e.precedence};}
      /// @endcond
    ...
    constexpr auto expression::greater_than_or_equal(left_t left, right_t right) {
      auto left_expression = as_expression(left);
      auto right_expression = as_expression(right);
      return greater_than_or_equal_expression<std::decay_t<decltype(left_expression)>, std::decay_t<decltype(right_expression)>> {std::move(left_expression), std::move(right_expression)};
    }
    /// @endcond
    ...
    constexpr auto operator >=(left_t left, right_t right) {return expression::greater_than_or_equal(std::move(left), std::move(right));}
    /// @}
  }
}

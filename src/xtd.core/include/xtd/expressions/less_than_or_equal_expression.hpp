/// @file
/// @brief Contains xtd::expressions::less_than_or_equal_expression operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::less_than_or_equal_expression is the less or equal expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    ...
    /// xtd.core
    /// @ingroup xtd_core
    /// @remarks The xtd::expressions::less_than_or_equal_expression struct is used by xtd::expressions::expression::less_than_or_equal expression.
    template<typename left_t, typename right_t>
    struct less_than_or_equal_expression : binary_expression {
      /// @name Public Fields
      ...
      constexpr less_than_or_equal_expression(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const less_than_or_equal_expression& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " <= " << expression_stream {e.right, e.precedence};}
      /// @endcond

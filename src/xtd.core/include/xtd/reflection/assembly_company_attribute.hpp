...
namespace xtd {
  ...
  namespace reflection {
    ...
    public:
      ...
      /// @param company The version information.
      /// @par Examples
      ...
      static auto create(const xtd::string& company) -> assembly_company_attribute;
      /// @}
...
#define assembly_company_(company) \
  auto __assembly_company_attribute = xtd::reflection::assembly_company_attribute::create(company)

...
namespace xtd {
  ...
  namespace reflection {
    ...
    public:
      ...
      /// @return `true` if the specified object is equal to the current object. otherwise, `false`.
      [[nodiscard]] auto equals(const assembly_identifier_attribute& other) const noexcept -> bool override;
      ...
      /// @{
      /// @brief Creates the assembly identifier information. Must be called once in your application.
...
/// @cond
auto __assembly_identifier_attribute__() -> xtd::sptr<xtd::reflection::assembly_identifier_attribute>& ;
/// @endcond
...
#define assembly_identifier_(identifier) \
  auto __assembly_identifier_attribute = xtd::reflection::assembly_identifier_attribute::create(identifier)

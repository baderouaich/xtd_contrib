...
for (const auto& line : contents)
    ...
    static auto append_all_text(const xtd::string& path, type_t text) -> void {
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be opened.
      [[nodiscard]] static auto append_text(const xtd::string& path) -> std::ofstream;
      ...
      [[nodiscard]] static auto create(const xtd::string& path) -> std::ofstream;
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path<br>-or-<br>file dest exists.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be created.
      [[nodiscard]] static auto create_text(const xtd::string& path) -> xtd::io::stream_writer;
      ...
      [[nodiscard]] static auto exists(const xtd::string& path) noexcept -> bool;
      ...
      /// @exception xtd::io::file_not_found_exception if file src does not exists.
      [[nodiscard]] static auto get_attributes(const xtd::string& path) -> xtd::io::file_attributes;
      ...
      [[nodiscard]] static auto get_creation_time(const xtd::string& path) -> xtd::date_time;
      ...
      /// @exception xtd::io::path_too_long_exception The specified path, file name, or both exceed the system-defined maximum length.
      /// @exception xtd::not_supported_excpttion path is in an invalid format.
      [[nodiscard]] static auto get_last_access_time(const xtd::string& path) -> xtd::date_time;
      ...
      /// @exception xtd::io::path_too_long_exception The specified path, file name, or both exceed the system-defined maximum length.
      /// @exception xtd::not_supported_excpttion path is in an invalid format.
      [[nodiscard]] static auto get_last_write_time(const xtd::string& path) -> xtd::date_time;
      
      /// @brief Gets the xtd::io::file_permissions of the file on the path.
      /// @param path The path to the file.
      /// @return The xtd::io::file_permissions of the file on the path.
      /// @exception xtd::io::file_not_found_exception if file src does not exists.
      [[nodiscard]] static auto get_permissions(const xtd::string& path) -> xtd::io::file_permissions;
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be opened.
      [[nodiscard]] static auto open(const xtd::string& path, std::ios::openmode mode) -> std::fstream;
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be opened.
      [[nodiscard]] static auto open_read(const xtd::string& path) -> std::ifstream;
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be opened.
      [[nodiscard]] static auto open_text(const xtd::string& path) -> xtd::io::stream_reader;
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be opened.
      [[nodiscard]] static auto open_write(const xtd::string& path) -> std::ofstream;
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be opened.
      [[nodiscard]] static auto read_all_bytes(const xtd::string& path) -> xtd::array<xtd::byte>;
      ...
      [[nodiscard]] static auto read_all_lines(const xtd::string& path) -> xtd::array<xtd::string>;
      ...
      [[nodiscard]] static auto read_all_text(const xtd::string& path) -> xtd::string;
...
for (const auto& line : contents)
    ...
    static auto write_all_text(const xtd::string& path, type_t text) -> void {
      ...
      /// @exception xtd::argument_exception path contains one or more of the invalid characters<br>-or-<br>The system could not retrieve the absolute path.
      /// @exception xtd::io::io_exception the handle of the specified file cannot be opened.
      [[nodiscard]] static auto write_text(const xtd::string& path) -> xtd::io::stream_writer;
      /// @}
    private:
      [[nodiscard]] static auto get_file_times(const string& path) -> std::tuple<std::time_t, std::time_t, std::time_t>;
    };
  }
}

...
#include "../../include/xtd/cpp_language.hpp"
...
language_id cpp_language::language() const noexcept {
  if (cpp_ >= as<int32>(language_id::cpp29)) return language_id::cpp29;
  if (cpp_ >= as<int32>(language_id::cpp26)) return language_id::cpp26;
...
xtd::string cpp_language::name() const noexcept {
  static auto names = std::map<language_id, xtd::string> {{language_id::cpp_pre98, "C++ Pre 98"}, {language_id::cpp98, "C++ 98"}, {language_id::cpp11, "C++ 11"}, {language_id::cpp14, "C++ 14"}, {language_id::cpp17, "C++ 17"}, {language_id::cpp20, "C++ 20"}, {language_id::cpp23, "C++ 23"}, {language_id::cpp26, "C++ 26"}, {language_id::unknown, "<unknown>"}};

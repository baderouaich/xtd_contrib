...
namespace {
  auto normalize_xtd_type_names(auto& name) {
  ...
  auto normalize_xtd_collections_specialized_type_names(auto& name) {
  ...
  auto normalize_xtd_collections_type_names(auto& name) {
  ...
  auto normalize_xtd_text_type_names(auto& name) {
  ...
  auto normalize_xtd_web_css_type_names(auto& name) {
    ...
    if (name.contains("xtd::collections::generic::sorted_dictionary<xtd::string, xtd::web::css::selector>")) name = name.replace("xtd::collections::generic::sorted_dictionary<xtd::string, xtd::web::css::selector>", "xtd::web::css::selector_dictionary");
  }
  
  auto normalize_type_name(auto& name) {
    normalize_xtd_type_names(name);
    normalize_xtd_collections_specialized_type_names(name);
    normalize_xtd_collections_type_names(name);
    normalize_xtd_text_type_names(name);
    normalize_xtd_web_css_type_names(name);
    return name;
  }
}

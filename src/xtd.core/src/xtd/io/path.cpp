...
auto path::alt_directory_separator_char() noexcept -> char {
  return native::path::alt_directory_separator_char();
}

auto path::change_extension(const string& path, const string& extension) -> string {
...
auto path::combine(const string& path1, const string& path2) -> string {
...
auto path::directory_separator_char() noexcept -> char {
  return native::path::directory_separator_char();
}

auto path::get_directory_name(const string& path) -> string {
...
auto path::get_temp_file_name() -> string {
  static auto rand = xtd::random {};
...
auto path::get_temp_path() noexcept -> string {
...
auto path::has_extension(const string& path) -> bool {
  return !string::is_empty(get_extension(path));
}

auto path::is_path_rooted(const string& path) -> bool {
  return __get_index_path_rooted(path) != -1;
}

auto path::path_separator() noexcept -> char {
  return native::path::path_separator();
}

auto path::volume_separator_char() noexcept -> char {

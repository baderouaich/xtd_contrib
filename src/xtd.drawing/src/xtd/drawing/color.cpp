...
bool color::is_dark() const noexcept {
  auto [hue, saturation, lightness] = to_hsl();
...
color color::from_hsb(const hsb& hsb) noexcept {
  return from_hsb(hsb.hue, hsb.saturation, hsb.brightness);
}
...
color color::from_hsl(const hsl& hsl) noexcept {
  return from_hsl(hsl.hue, hsl.saturation, hsl.lightness);
}
...
color color::from_known_color(known_color color) {
  switch (color) {
    ...
    case known_color::crayon_iron: return drawing::color {color::from_argb(0xFF4C4C4C), color};
    case known_color::crayon_steel: return drawing::color {color::from_argb(0xFF666666), color};
    case known_color::crayon_tin: return drawing::color {color::from_argb(0xFF7F7F7F), color};
    case known_color::crayon_nickel: return drawing::color {color::from_argb(0xFF808080), color};
    case known_color::crayon_aluminium: return drawing::color {color::from_argb(0xFF999999), color};
    case known_color::crayon_magnesium: return drawing::color {color::from_argb(0xFFB3B3B3), color};
    case known_color::crayon_silver: return drawing::color {color::from_argb(0xFFCCCCCC), color};
    case known_color::crayon_mercury: return drawing::color {color::from_argb(0xFFE6E6E6), color};
    case known_color::crayon_snow: return drawing::color {color::from_argb(0xFFFFFFFF), color};
    case known_color::crayon_cayenne: return drawing::color {color::from_argb(0xFF800002), color};
    case known_color::crayon_mocha: return drawing::color {color::from_argb(0xFF804003), color};
    case known_color::crayon_asparagus: return drawing::color {color::from_argb(0xFF808004), color};
    case known_color::crayon_fern: return drawing::color {color::from_argb(0xFF408002), color};
    case known_color::crayon_clover: return drawing::color {color::from_argb(0xFF118002), color};
    case known_color::crayon_moss: return drawing::color {color::from_argb(0xFF118040), color};
    case known_color::crayon_teal: return drawing::color {color::from_argb(0xFF108080), color};
    case known_color::crayon_ocean: return drawing::color {color::from_argb(0xFF074080), color};
    case known_color::crayon_midnight: return drawing::color {color::from_argb(0xFF000080), color};
    case known_color::crayon_eggplant: return drawing::color {color::from_argb(0xFF400080), color};
    case known_color::crayon_plum: return drawing::color {color::from_argb(0xFF800080), color};
    case known_color::crayon_maroon: return drawing::color {color::from_argb(0xFF800040), color};
    case known_color::crayon_maraschino: return drawing::color {color::from_argb(0xFFFB0207), color};
    case known_color::crayon_tangerine: return drawing::color {color::from_argb(0xFFFD8008), color};
    case known_color::crayon_lemon: return drawing::color {color::from_argb(0xFFFFFF0A), color};
    case known_color::crayon_lime: return drawing::color {color::from_argb(0xFF80FF08), color};
    case known_color::crayon_spring: return drawing::color {color::from_argb(0xFF21FF06), color};
    case known_color::crayon_sea_foam: return drawing::color {color::from_argb(0xFF21FF80), color};
    case known_color::crayon_turquoise: return drawing::color {color::from_argb(0xFF21FFFF), color};
    case known_color::crayon_aqua: return drawing::color {color::from_argb(0xFF0F80FF), color};
    case known_color::crayon_blueberry: return drawing::color {color::from_argb(0xFF0000FF), color};
    case known_color::crayon_grape: return drawing::color {color::from_argb(0xFF8000FF), color};
    case known_color::crayon_magenta: return drawing::color {color::from_argb(0xFFFB02FF), color};
    case known_color::crayon_strawberry: return drawing::color {color::from_argb(0xFFFB0280), color};
    case known_color::crayon_salmon: return drawing::color {color::from_argb(0xFFFC6666), color};
    case known_color::crayon_cantaloupe: return drawing::color {color::from_argb(0xFFFECC66), color};
    case known_color::crayon_banana: return drawing::color {color::from_argb(0xFFFFFF66), color};
    case known_color::crayon_honeydew: return drawing::color {color::from_argb(0xFFCCFF66), color};
    case known_color::crayon_flora: return drawing::color {color::from_argb(0xFF66FF66), color};
    case known_color::crayon_spindrift: return drawing::color {color::from_argb(0xFF66FFCC), color};
    case known_color::crayon_ice: return drawing::color {color::from_argb(0xFF66FFFF), color};
    case known_color::crayon_sky: return drawing::color {color::from_argb(0xFF66CCFF), color};
    case known_color::crayon_orchid: return drawing::color {color::from_argb(0xFF6666FF), color};
    ...
    default: throw_helper::throws(exception_case::argument, "know_color invalid");
  }
}

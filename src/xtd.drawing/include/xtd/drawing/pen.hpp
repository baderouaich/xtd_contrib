...
namespace xtd {
  ...
  namespace drawing {
    ...
    public:
      ...
      auto operator =(const xtd::drawing::pen& value) -> xtd::drawing::pen&;
      ~pen();
      /// @endcond
      ...
      [[nodiscard]] auto alignment() const noexcept -> xtd::drawing::drawing_2d::pen_alignment;
      ...
      [[nodiscard]] auto dash_pattern() const noexcept -> xtd::array<float>;
      ...
      [[nodiscard]] auto dash_style() const noexcept -> xtd::drawing::drawing_2d::dash_style;
      ...
      [[nodiscard]] auto end_cap() const noexcept -> xtd::drawing::drawing_2d::line_cap;
      ...
      [[nodiscard]] auto line_join() const noexcept -> xtd::drawing::drawing_2d::line_join;
      ...
      [[nodiscard]] float miter_limit() const noexcept;
      ...
      [[nodiscard]] auto start_cap() const noexcept -> xtd::drawing::drawing_2d::line_cap;
      ...
      [[nodiscard]] auto type() const noexcept -> xtd::drawing::drawing_2d::pen_type;
      ...
      /// @cond
      auto dash_pattern(const std::initializer_list<float>& value) -> xtd::drawing::pen&;
      /// @endcond
      ...
      [[nodiscard]] auto equals(const xtd::drawing::pen& other) const noexcept -> bool override;
    ...
    private:
      auto brush_(xtd::uptr<xtd::drawing::brush>&& brush) -> void;
      auto color_(const xtd::drawing::color& color) -> void;

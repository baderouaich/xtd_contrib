...
namespace xtd {
  ...
  namespace drawing {
    ...
    public:
      ...
      /// @{
      /// @brief Translates an CMYK color representation to a GDI+ xtd::drawing::color structure.
      /// @param text The string representation of the CMYK color to translate.
      /// @return The xtd::drawing::color structure that represents the translated CMYK color or xtd::drawing::color::empty if text is empty ("").
      /// @exception xtd:format_exception text is not a valid CMYK color name.
      [[nodiscard]] static auto from_cmyk(const xtd::string& text) -> xtd::drawing::color;
      
      /// @brief Translates an CMYKA color representation to a GDI+ xtd::drawing::color structure.
      /// @param text The string representation of the CMYKA color to translate.
      ...
      [[nodiscard]] static auto from_hex(const xtd::string& text) -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto from_hsl(const xtd::string& text) -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto from_hsla(const xtd::string& text) -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto from_hsv(const xtd::string& text) -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto from_hsva(const xtd::string& text) -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto from_html(const xtd::string& text) -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto from_rgb(const xtd::string& text) -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto from_rgba(const xtd::string& text) -> xtd::drawing::color;
      ...
      /// @return The string that represents the HSL CMYK.
      /// @remarks This method translates an xtd::drawing::color structure into a string representation of a CMYK color (e.g. "cmyk(100%, 90%, 30%, 64%)").
      [[nodiscard]] static auto to_cmyk(const xtd::drawing::color& value) noexcept -> xtd::string;
      /// @brief Translates the specified xtd::drawing::color structure to an CMYK string color representation.
      /// @param value The xtd::drawing::color structure to translate.
      /// @param auto_cmyk If `true` and alpha channel is not 100% use CMYKA; otherwise always use CMYK.
      /// @return The string that represents the HSL color.
      /// @remarks This method translates an xtd::drawing::color structure into a string representation of a CMYK color (e.g. "hsl(100%, 90%, 30%, 64%)").
      [[nodiscard]] static auto to_cmyk(const xtd::drawing::color& value, bool auto_cmyk) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_hex(const xtd::drawing::color& value) noexcept -> xtd::string;
      /// @brief Translates the specified xtd::drawing::color structure to an HEX string color representation.
      /// @param value The xtd::drawing::color structure to translate.
      /// @return The string that represents the HEX color.
      /// @remarks This method translates an xtd::drawing::color structure into a string representation of a HEX color (e.g. "#ff6347").
      [[nodiscard]] static auto to_hex(const xtd::drawing::color& value, bool auto_hexa) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_hsl(const xtd::drawing::color& value) noexcept -> xtd::string;
      /// @brief Translates the specified xtd::drawing::color structure to an HSL string color representation.
      /// @param value The xtd::drawing::color structure to translate.
      /// @param auto_hsla If `true` and alpha channel is not 100% use HSLA; otherwise always use HSL.
      /// @return The string that represents the HSL color.
      /// @remarks This method translates an xtd::drawing::color structure into a string representation of a HSL color (e.g. "hsl(9, 100%, 64%)").
      [[nodiscard]] static auto to_hsl(const xtd::drawing::color& value, bool auto_hsla) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_hsla(const xtd::drawing::color& value) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_hsv(const xtd::drawing::color& value) noexcept -> xtd::string;
      /// @brief Translates the specified xtd::drawing::color structure to an HSV string color representation.
      /// @param value The xtd::drawing::color structure to translate.
      /// @param auto_hsva If `true` and alpha channel is not 100% use HSLA; otherwise always use HSL.
      /// @return The string that represents the HSL color.
      /// @remarks This method translates an xtd::drawing::color structure into a string representation of a HSV color (e.g. "hsl(9, 100%, 64%)").
      [[nodiscard]] static auto to_hsv(const xtd::drawing::color& value, bool auto_hsva) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_hsva(const xtd::drawing::color& value) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_html(const xtd::drawing::color& value) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_rgb(const xtd::drawing::color& value) noexcept -> xtd::string;
      /// @brief Translates the specified xtd::drawing::color structure to an RGB string color representation.
      /// @param value The xtd::drawing::color structure to translate.
      /// @param auto_rgba If `true` and alpha channel is not 100% use RGB; otherwise always use RGB.
      /// @return The string that represents the RGB color.
      /// @remarks This method translates an xtd::drawing::color structure into a string representation of a RGB color (e.g."rgb(255, 99, 71)").
      [[nodiscard]] static auto to_rgb(const xtd::drawing::color& value, bool auto_rgba) noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto to_rgba(const xtd::drawing::color& value) noexcept -> xtd::string;
      
      /// @brief Translates the specified xtd::drawing::color structure to a Windows color.
      /// @param value The xtd::drawing::color structure to translate.
      /// @return The Windows color value.
      [[nodiscard]] static auto to_win32(const xtd::drawing::color& value) noexcept -> xtd::int32;
    ...
    private:
      ...
      [[nodiscard]] static auto from_name(const xtd::drawing::color& value) -> xtd::string;
      [[nodiscard]] static auto try_parse_cmyk_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;
      [[nodiscard]] static auto try_parse_cmyka_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;
      [[nodiscard]] static auto try_parse_hex_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;
      [[nodiscard]] static auto try_parse_hsl_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;
      [[nodiscard]] static auto try_parse_hsla_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;
      [[nodiscard]] static auto try_parse_hsv_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;
      [[nodiscard]] static auto try_parse_hsva_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;
      [[nodiscard]] static auto try_parse_html_color(const xtd::string& text, xtd::drawing::color& result) noexcept -> bool;

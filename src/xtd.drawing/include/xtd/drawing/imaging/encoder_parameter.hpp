...
#pragma once
#include "encoder.hpp"
#include "encoder_parameter_value_type.hpp"
  ...
  namespace drawing {
    ...
    namespace imaging {
      ...
      public:
        ...
        /// @param encoder An xtd::drawing::imaging::encoder object that encapsulates the globally unique identifier of the parameter category.
        /// @param number_of_values An integer that specifies the number of values stored in the EncoderParameter object. The xtd::drawing::imaging::encoder_parameter::number_of_values property is set to this value.
        /// @param type A member of the xtd::drawing::imaging::encoder_parameter_value_type enumeration that specifies the data type of the values stored in the xtd::drawing::imaging::encoder_parameter::encoder_parameter object. The xtd::drawing::imaging::type and xtd::drawing::imaging::value_type properties are set to this value.
        /// @param value A pointer to an array of values of the type specified by the `type` parameter.

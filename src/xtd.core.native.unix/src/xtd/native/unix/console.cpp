...
bool console::number_lock() {
  /// @todo number lock status on unix
  return ::number_lock;
}
...
std::string console::title() {
  /// @todo get console get title on unix
...
bool console::window_height(int32_t height) {
  /// @todo set console window height on unix
  ::window_height = height;
  return true;
}

int32_t console::window_left() {
  /// @todo get console window left on unix
  return ::window_left;
}

bool console::window_left(int32_t left) {
  /// @todo set console window left on unix
  ::window_left = left;
  return true;
}

int32_t console::window_top() {
  /// @todo get console window top on unix
  return ::window_top;
}

bool console::window_top(int32_t top) {
  /// @todo set console window top on unix
  ::window_top = top;
  return true;
}
...
bool console::window_width(int32_t width) {
  /// @todo set console window width on unix
  ::window_width = width;
  return true;
}

...
int32_t console::input_code_page() {
  // There is no way to define the console input code page under freebsd.
...
bool console::number_lock() {
  /// @todo number lock status on freebsd
  return ::number_lock;
}

int32_t console::output_code_page() {
  // There is no way to define the console output code page under freebsd.
...
std::string console::title() {
  /// @todo get console get title on freebsd
...
bool console::window_height(int32_t height) {
  /// @todo set console window height on freebsd
  ::window_height = height;
  return true;
}

int32_t console::window_left() {
  /// @todo get console window left on freebsd
  return ::window_left;
}

bool console::window_left(int32_t left) {
  /// @todo set console window left on freebsd
  ::window_left = left;
  return true;
}

int32_t console::window_top() {
  /// @todo get console window top on freebsd
  return ::window_top;
}

bool console::window_top(int32_t top) {
  /// @todo set console window top on freebsd
  ::window_top = top;
  return true;
}
...
bool console::window_width(int32_t width) {
  /// @todo set console window width on freebsd
  ::window_width = width;
  return true;
}

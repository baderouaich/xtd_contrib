...
namespace xtd::tests {
  generic_test_class_(box_integer_typeests, signed char, unsigned char, short, unsigned short, int, unsigned int, long, unsigned long, long long, unsigned long long, sbyte, int16, int32, int64, intptr, ptrdiff, usize, byte, uint16, uint32, uint64, uintptr) {

...
namespace xtd::diagnostics::tests {
  class test_class_(trace_listener_tests) {
    ...
    auto test_method_(new_trace_listener) {
    ...
    auto test_method_(trace_data_with_int) {
      unit_test_trace_listener trace_listener;
    ...
    auto test_method_(trace_data_with_string_aarray) {
      unit_test_trace_listener trace_listener;
    ...
    auto test_method_(trace_transfer) {
      unit_test_trace_listener trace_listener;
    ...
    auto test_method_(write_string) {
      unit_test_trace_listener trace_listener;
      trace_listener.write("string");
      assert::are_equal("string", trace_listener.result());
    }
    
    auto test_method_(write_int) {
      unit_test_trace_listener trace_listener;
      trace_listener.write(42);
      assert::are_equal("42", trace_listener.result());
    }
    
    auto test_method_(write_line_string) {
      unit_test_trace_listener trace_listener;
      trace_listener.write_line("string");
      assert::are_equal("string\n", trace_listener.result());
    }
    
    auto test_method_(write_line_int) {
      unit_test_trace_listener trace_listener;
      trace_listener.write_line(42);
      assert::are_equal("42\n", trace_listener.result());
    }
    
    auto test_method_(write_stream_string) {
      unit_test_trace_listener trace_listener;
      trace_listener << "string";
      assert::are_equal("string\n", trace_listener.result());
    }
    
    auto test_method_(write_stream_int) {
      unit_test_trace_listener trace_listener;
      trace_listener << 42;
      assert::are_equal("42\n", trace_listener.result());
    }
    
    auto test_method_(write_string_with_one_indent_level) {
      unit_test_trace_listener trace_listener;
    ...
    auto test_method_(write_string_with_two_indent_level) {
      unit_test_trace_listener trace_listener;
      trace_listener.indent_size(8);
